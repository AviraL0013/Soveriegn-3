...
export const metadata: Metadata = {
  title: "Sovereign Protocol // Control Plane v2.4",
  description:
    "Autonomous economic agreement protocol for machine-to-machine financial covenants using zero-knowledge proofs.",
};
