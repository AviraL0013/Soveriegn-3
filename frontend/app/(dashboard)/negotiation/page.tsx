      ...
      <section className="border-b-2 border-on-surface pb-unit-5 flex flex-col md:flex-row md:items-end justify-between gap-unit-4">
        <div>
          ...
          <p className="font-body-md text-body-md text-secondary mt-1">
            Autonomous agents negotiating financial terms.
          </p>
        </div>
        <div className="flex items-center gap-unit-3">
          <div className="border border-on-surface bg-surface-container-lowest px-unit-3 py-unit-2 neo-shadow">
            <div className="font-label-caps text-label-caps text-secondary">PROTOCOL DRIFT</div>
            <div className="font-code-md text-code-md font-semibold text-on-surface">0.00% [BOUNDED]</div>
          </div>
          <div className="border border-on-surface bg-surface-container-lowest px-unit-3 py-unit-2 neo-shadow">
            <div className="font-label-caps text-label-caps text-secondary">CONSENSUS LATENCY</div>
            <div className="font-code-md text-code-md font-semibold text-tertiary">98ms (ARC-NET)</div>
          </div>
        </div>
      </section>
          ...
          <div className="p-unit-4 flex flex-col gap-unit-3">
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="font-code-sm text-code-sm text-primary font-semibold">alice.sovereign.eth</div>
              </div>
            ...
            <div className="pt-unit-2 border-t border-surface-container-high font-code-sm text-code-sm flex flex-col gap-1">
              <div className="flex justify-between"><span className="text-secondary">Signer Status:</span><span className="font-semibold text-tertiary">AUTHORIZED</span></div>
              <div className="flex justify-between"><span className="text-secondary">Public Key:</span><span>0x82a9...91fd</span></div>
            </div>
          </div>
        </div>
          ...
          <div className="p-unit-4 flex flex-col gap-unit-3">
            <div className="flex items-start justify-between">
              <div>
                ...
                <div className="font-code-sm text-code-sm text-primary font-semibold">bob.sovereign.eth</div>
              </div>
              <span className="font-label-caps text-label-caps border border-on-surface bg-[#FEF3C7] text-[#B45309] px-unit-2 py-1 font-semibold">
                NEGOTIATING
              </span>
            ...
            <div className="pt-unit-2 border-t border-surface-container-high font-code-sm text-code-sm flex flex-col gap-1">
              <div className="flex justify-between"><span className="text-secondary">Signer Status:</span><span className="font-semibold text-tertiary">AUTHORIZED</span></div>
              <div className="flex justify-between"><span className="text-secondary">Public Key:</span><span>0x51d2...87ab</span></div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="flex items-center justify-between border-b border-on-surface pb-unit-2">
          <div className="flex items-center gap-unit-2">
            ...
            <h2 className="font-label-caps text-label-caps font-bold uppercase tracking-wider text-on-surface">
              STRUCTURED NEGOTIATION TIMELINE (DETERMINISTIC CONVERGENCE)
            </h2>
          </div>
          <span className="font-label-caps text-label-caps text-secondary">SYNC_STATE: 4 ROUNDS RECORDED</span>
        </div>
              ...
              <article key={round.round} className={`relative z-10 md:ml-12 bg-surface-container-lowest border ${isLast ? "border-2 border-on-surface neo-shadow-lg" : "border-on-surface neo-shadow"}`}>
                ...
                <div className="p-unit-4 flex flex-col gap-unit-3">
                  ...
                  <div className="bg-surface-container-lowest border border-on-surface p-unit-3">
                    <div className="font-label-caps text-label-caps text-secondary uppercase">Deterministic Policy Rationale</div>
                    <p className={`font-code-md text-code-md mt-0.5 ${isLast ? "font-semibold text-on-surface" : "text-on-surface"}`}>"{round.rationale}"</p>
                  </div>
                  <div className="flex flex-wrap items-center justify-between border-t border-surface-container-high pt-unit-2 text-on-surface">
                    <div className="flex items-center gap-unit-2 font-code-sm text-code-sm">
                      ...
                      <span className="font-semibold">{round.signature}</span>
                      <span className="font-label-caps text-label-caps border border-on-surface bg-[#E6F4EA] text-[#00875A] px-1.5 py-0.5 font-bold">{round.sigStatus}</span>
                    </div>
                    <div className="font-label-caps text-label-caps text-secondary">{isLast ? "CRYPTOGRAPHIC PROOF LOCKED" : "VALIDATED VIA EIP-712 SCHEME"}</div>
                  </div>
                </div>
              </article>
            );
      ...
      <section className="border-2 border-on-surface bg-surface-container-lowest p-unit-6 neo-shadow-lg flex flex-col md:flex-row md:items-center justify-between gap-unit-6">
        <div className="flex flex-col gap-unit-2">
          <div className="flex items-center gap-unit-2">
            ...
            <span className="font-label-caps text-label-caps text-tertiary font-bold tracking-wider">STATUS: PROTOCOL RESOLUTION</span>
          </div>
          <h3 className="font-headline-md text-headline-md font-bold text-on-surface tracking-tight">AGREEMENT TERMS CONVERGED (#SOV-8F29)</h3>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-unit-3">
          <div className="border border-dashed border-on-surface bg-surface-container-low px-unit-4 py-unit-2 flex flex-col justify-center">
            <div className="font-label-caps text-label-caps text-secondary">PROOF OF STATE ROOT</div>
            <div className="font-code-sm text-code-sm font-semibold text-on-surface">0xde44...a901</div>
          </div>
